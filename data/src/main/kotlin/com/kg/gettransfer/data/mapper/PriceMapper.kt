...
open class PriceMapper(private val moneyMapper: MoneyMapper): Mapper<PriceEntity, Price> {
    ...
    override fun fromEntity(type: PriceEntity) = 
        Price(moneyMapper.fromEntity(type.base), type.percentage_30, type.percentage_70, type.amount)
    /**
     * Map a [Price] instance to a [PriceEntity] instance.
     */
    override fun toEntity(type: Price) = 
        PriceEntity(moneyMapper.toEntity(type.base), type.percentage30, type.percentage70, type.amount)
}
