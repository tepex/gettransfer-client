...
open class RouteDataStoreRemote: RouteDataStore {
    ...
    override suspend fun getRouteInfo(request: RouteInfoRequestEntity) =
        remote.getRouteInfo(request)

    override suspend fun getRouteInfo(request: RouteInfoHourlyRequestEntity) =
        remote.getRouteInfo(request)
