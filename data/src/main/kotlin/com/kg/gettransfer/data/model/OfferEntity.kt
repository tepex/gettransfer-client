...
@Serializable
data class OfferEntity(@SerialName(ID) val id: Long,
...
@Serializable
data class RatingsEntity(@SerialName(AVERAGE) val average: Float?,
...
@Serializable
data class CarrierEntity(@SerialName(ID) val id: Long,
...
@Serializable
data class VehicleEntity(@SerialName(NAME) val name: String,
