...
class ApiAccount(@SerializedName(ACCOUNT_EMAIL) @Expose var email: String?,
                 @SerializedName(ACCOUNT_PHONE) @Expose var phone: String?,
                 @SerializedName(ACCOUNT_LOCALE) @Expose var locale: String?,
                 @SerializedName(ACCOUNT_CURRENCY) @Expose var currency: String?,
                 @SerializedName(ACCOUNT_DISTANCE_UNIT) @Expose var distanceUnit: String?,
                 @SerializedName(ACCOUNT_FULL_NAME) @Expose var fullName: String?,
                 @SerializedName(ACCOUNT_GROUPS) @Expose var groups: Array<String>?,
                 @SerializedName(ACCOUNT_TERMS_ACCEPTED) @Expose var termsAccepted: Boolean = false)
