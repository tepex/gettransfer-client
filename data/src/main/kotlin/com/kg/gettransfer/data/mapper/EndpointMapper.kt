...
open class EndpointMapper(): Mapper<EndpointEntity, Endpoint> {
     ...
     */
    override fun fromEntity(type: EndpointEntity) = Endpoint(type.name, type.key, type.url, type.isDemo)
    /**
     * Map a [Endpoint] instance to a [EndpointEntity] instance.
     */
    override fun toEntity(type: Endpoint) = EndpointEntity(type.name, type.key, type.url, type.isDemo)
}
