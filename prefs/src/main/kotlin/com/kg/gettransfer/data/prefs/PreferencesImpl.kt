...
class PreferencesImpl(context: Context): Preferences {
    ...
    override var lastAddresses: String
//        get() = GTAddressModel(accountPrefs.getString(ACCOUNT_HISTORY, null))
        get() = accountPrefs.getString(ACCOUNT_HISTORY, "[]")
        set(value) {
            accountPrefs.edit()
                    .putString(ACCOUNT_HISTORY,value)
                    .apply()
        }
}
