...
data class GTAddress(
    ...
    fun needApproximation() = 
        if (placeTypes.isEmpty()) false else placeTypes.any { it == "route" }

    override fun equals(other: Any?): Boolean {
        if (this === other) return true
        if (other == null || javaClass != other.javaClass) return false
        val eq = other as GTAddress
        return if (cityPoint.placeId.isNotEmpty() && eq.cityPoint.placeId.isNotEmpty()) {
    ...
    override fun hashCode(): Int = cityPoint.placeId.hashCode()
    ...
    companion object {
        ...
        val EMPTY = GTAddress(CityPoint.EMPTY, emptyList<String>(), "", Pair("", ""))
