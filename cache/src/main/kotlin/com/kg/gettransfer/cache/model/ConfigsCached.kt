...
data class ConfigsCached(@ColumnInfo(name = ConfigsEntity.TRANSPORT_TYPES) val transportTypes: TransportTypesCachedList,
...
@Serializable
data class CurrencyCached(@ColumnInfo(name = CurrencyEntity.ISO_CODE) val code: String,
...
data class CardGatewaysCached(@ColumnInfo(name = CardGatewaysEntity.DEFAULT) val def: String,
