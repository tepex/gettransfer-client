...
class AccountCached(fullName: String?, email: String?, phone: String?,
                    ...
                    @ColumnInfo(name = AccountEntity.TERMS_ACCEPTED) val termsAccepted: Boolean?,
                    @ColumnInfo(name = AccountEntity.CARRIER_ID) val carrierId: Long?,
                    @PrimaryKey(autoGenerate = true) val id: Long = 0): ProfileCached(fullName, email, phone)
