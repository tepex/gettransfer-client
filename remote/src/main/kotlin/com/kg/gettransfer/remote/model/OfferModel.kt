...
data class OfferModel(
    ...
    @SerializedName(OfferEntity.NAME_SIGN_PRESENT)   @Expose val nameSignPresent: Boolean,
    @SerializedName(OfferEntity.WITH_NAME_SIGN)      @Expose val withNameSign: Boolean,
