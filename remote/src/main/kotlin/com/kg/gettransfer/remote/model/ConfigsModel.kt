...
class PaypalCredentialsModel(@SerializedName(PaypalCredentialsEntity.ID) @Expose val id: String,
                             @SerializedName(PaypalCredentialsEntity.ENV) @Expose val env: String)

class CurrencyModel(@SerializedName(CurrencyEntity.ISO_CODE) @Expose val code: String,
                    @SerializedName(CurrencyEntity.SYMBOL) @Expose val symbol: String)

class CardGatewaysModel(@SerializedName(CardGatewaysEntity.DEFAULT) @Expose val default: String,
