...
open class MoneyMapper(): EntityMapper<MoneyModel, MoneyEntity> {
    override fun fromRemote(type: MoneyModel) = MoneyEntity(type.default, type.preferred) 
    override fun toRemote(type: MoneyEntity) = MoneyModel(type.default, type.preferred)
}
