...
class PopularAddressAdapter(private val presenter: SearchPresenter,
                            private val list: List<PopularPlace>): RecyclerView.Adapter<PopularAddressAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: PopularAddressAdapter.ViewHolder, pos: Int) = holder.bind(list[pos])
                                                                           { presenter.onPopularSelected(it) }
