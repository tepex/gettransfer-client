...
class PopularAddressAdapter(private val list: List<PopularPlace>,
                            private val click: (PopularPlace) -> Unit): RecyclerView.Adapter<PopularAddressAdapter.ViewHolder>() {
