...
public class BottomSheetTripleStatesBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
     ...
     */
    public BottomSheetTripleStatesBehavior() { }
     ...
     */
    public BottomSheetTripleStatesBehavior(Context context, AttributeSet attrs ) {
        super( context, attrs );
...
//            mCallback.onStateChanged(bottomSheet, state);
    ...
    /**
     * A utility function to get the {@link BottomSheetTripleStatesBehavior} associated with the {@code view}.
     *
     * @param view The {@link View} with {@link BottomSheetTripleStatesBehavior}.
     * @param <V> Instance of behavior
     * @return The {@link BottomSheetTripleStatesBehavior} associated with the {@code view}.
     */
    @SuppressWarnings("unchecked")
    public static <V extends View> BottomSheetTripleStatesBehavior<V> from(V view) {
        ...
        CoordinatorLayout.Behavior behavior = ((CoordinatorLayout.LayoutParams) params)
                .getBehavior();
        if (!(behavior instanceof BottomSheetTripleStatesBehavior)) {
            throw new IllegalArgumentException(
                    "The view is not associated with BottomSheetTripleStatesBehavior");
        }
        return (BottomSheetTripleStatesBehavior<V>) behavior;
    }
