...
import com.kg.gettransfer.presentation.presenter.TransferDetailsPresenter2
import com.kg.gettransfer.presentation.view.TransferDetailsView2
...
class TransferDetailsActivity2: BaseGoogleMapActivity(), TransferDetailsView2 {
    @InjectPresenter
    internal lateinit var presenter: TransferDetailsPresenter2

    @ProvidePresenter
    fun createTransferDetailsPresenter2() = TransferDetailsPresenter2()

    override fun getPresenter(): TransferDetailsPresenter2 = presenter

    @CallSuper
    protected override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        presenter.transferId = intent.getLongExtra(TransferDetailsView2.EXTRA_TRANSFER_ID, 0)
