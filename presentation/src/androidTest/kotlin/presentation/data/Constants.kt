...
object Constants {
    ...
    const val TEXT_EMAIL_IVAN = "i.marchenkov+42@gettransfer.com"
    const val TEXT_RECARDO = "Ricardo"
    const val TEXT_NUMBER_IVAN = "79116789567"
    const val TEXT_GO_UP = "Перейти вверх"
    const val TEXT_RANDOM_NUMBER = "3000000"
    ...
    const val TEXT_URL_CHANGE_EMAIL =
        "https://api.mailslurp.com/waitForLatestEmail?inboxId=f1005acf-74f8-47c0-adcf-88d935bea8d6&timeout=222"
    ...
    const val TEXT_URL_EMAIL_SIM =
        "https://api.mailslurp.com/waitForLatestEmail?inboxId=9ffad70e-75ab-4a22-9450-17a9c8a3a3a7&timeout=222"
