...
import com.kg.gettransfer.module.http.ObservableResponse
import com.kg.gettransfer.module.http.json.BaseResponse
import com.kg.gettransfer.module.http.json.Payment
import com.kg.gettransfer.module.http.json.PingResponse
import com.kg.gettransfer.module.http.json.TransferField
...
class TransferModel(
    ...
    fun payment(offerID: Int, full: Boolean): Observable<com.kg.gettransfer.module.http.json.BaseResponse<Payment>> {
